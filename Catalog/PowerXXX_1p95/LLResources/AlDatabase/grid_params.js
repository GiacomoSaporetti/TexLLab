var GRIDNAME = "AlDatabaseParams"   // nome della griglia, usato in file INI
...
/*						label:		 18,
						translation: 19,
						visibility:	 20,
						clientType:	 21 // non usato ma messo perchè presente nell'XML */
					}
...
{	
	...
	m_addressRange = app.CallFunction(m_extName + ".GetParamsAddressRange")
	m_ipaRange     = app.CallFunction(m_extName + ".GetParamsIpaRange")
...
/*	grid.AddColumn( 140, 100, false, false, egColumnType.egEdit,  		0, app.Translate("Label") )
	...
	grid.AddColumn( 0, 100, true, false, egColumnType.egCombo,  		0, app.Translate("Client Type") , "clientTypeEnum") // // non usato ma messo perchè presente nell'XML
	*/
