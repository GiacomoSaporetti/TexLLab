function OnOK()
{
    ...
    var findInLocation = chkFindInLocation.checked;
    var findInType = chkFindInType.checked;

    if (!findInName && !findInLocation && !findInType) {
...
function RestoreCriteria() {
    ...
    if (criteria) {
        ...
        chkFindInLocation.checked = criteria.findInLocation;
    }
}
